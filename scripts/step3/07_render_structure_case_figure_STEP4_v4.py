...
def main():
    ...
    for i, (_, row) in enumerate(cases.iterrows()):
        ...
        ax_h.text(0.0445, 0.50, chr(65 + i), ha="center", va="center", fontsize=17.52, fontweight="bold", color="white")
        ...
        ax_f.text(0.03, 0.43, f"A mean metal REPEAT q/e: {summarize_charge(elements, id_a)}", ha="left", va="center",
                  fontsize=8.58, color=COL["muted"], fontweight="bold")
        ...
        ax_f.text(0.03, 0.24, chem_line, ha="left", va="center",
                  fontsize=8.58, color=accent, fontweight="bold")

        ax_f.text(0.03, 0.075, ROLE_NOTE[role], ha="left", va="center",
                  fontsize=8.10, color=COL["muted"], fontstyle="italic" if role == "functional_motif_example" else "normal")
        source_rows.append({
            "panel": chr(65 + i),
